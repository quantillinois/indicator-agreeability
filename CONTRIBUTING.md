...
We would love for you to contribute to IA and help it make it better than it is today. As a contributor, here are the guidelines that we would like you to follow in order to remain consistent with our existing codebase.

## Code of Conduct

Help us keep IA open and inclusive. Please read and follow our [Code of Conduct](./CONDUCT.md)
...
3. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the IA repo.
...
11. In GitHub, send a pull request to `indicator-agreeability:main`.
